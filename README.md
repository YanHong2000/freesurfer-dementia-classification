...
臨床資料與 3D T1 MRI 涉及人體研究資料。由於目前無法確認受試者層級資料是否具有公開再散布授權，本 repository 不提供原始臨床資料、MRI / DICOM 影像、FreeSurfer 個體輸出及其他受試者層級分析資料。

Repository 主要提供彙整後統計結果、研究圖表、分析流程與論文內容，作為研究成果與方法展示。
